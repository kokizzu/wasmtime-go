<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v48">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v48?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v48@v48.0.1
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v48
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v48",
    version = "v48.0.1",
)
```
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v48.0.0 release artifacts'
$ git tag v48.0.0
```
