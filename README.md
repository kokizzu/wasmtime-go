<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v47">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v47?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v47@v47.0.1
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v47
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v47",
    version = "v47.0.1",
)
```
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v47.0.0 release artifacts'
$ git tag v47.0.0
```
